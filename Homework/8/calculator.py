...
def handle_exception(e: Exception) -> None:
    ...
    if isinstance(e, NotNumberError):
        ...
        print(f"Ошибка: Деление на ноль. попробуй снова")
    else:
...
def main() -> None:
    ...
    while True:
        try:
            ...
            if not input_is_number(number_one_str):
